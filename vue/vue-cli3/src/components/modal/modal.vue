    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer border-top">
          <a href="javascript:void(0)" class="confirm" v-if="modal.showCancelButton" @click="modalCancel">{{modal.cancelButtonText}}</a>
          <a href="javascript:void(0)" class="cancel" @click="modalConfirm" >{{modal.confirmButtonText}}</a>
        </div>
      </div>
    </div>
  </div>
